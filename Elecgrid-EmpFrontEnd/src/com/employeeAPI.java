...
public class employeeAPI extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		emplyeeServices empObj = new emplyeeServices();
		String output = empObj.insertEmp(request.getParameter("e_name"),
				request.getParameter("e_mobile"),
	...
	protected void doPut(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		emplyeeServices empObj = new emplyeeServices();
		String output = empObj.updateEmp(paras.get("hidemployeeIDSave").toString(),
				paras.get("e_name").toString(),
				paras.get("e_mobile").toString(),
